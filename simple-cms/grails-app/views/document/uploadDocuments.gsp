...
<body>
	<div class="scmsHtmlContainer">
		...
		<uploader:uploader id="mscUploader" url="${[controller:'document', action:'upload']}" buttonText="Upload Documents" sizeLimit="${50 * 1024 * 1024}" allowedExtensions="[ /'pdf'/, /'doc'/, /'docx'/, /'xls'/, /'xlsx'/, /'ppt'/, /'pptx'/, /'kml'/ , /'kmz'/ , /'wav'/  ]" />
	</div>
</body>
</html>