...
<html>
	...
	<body>
		<a href="#create-SCMSMenuItem" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-SCMSMenuItem" class="content scaffold-create" role="main">
